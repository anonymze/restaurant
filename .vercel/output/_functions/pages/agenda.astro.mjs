...
Écrivez-nous un courriel, appelez-nous ou venez nous parler sur place de ce que vous aimeriez vivre,
					organiser ou réaliser chez Mauvaise Herbe. <a class="text-primary underline underline-offset-4" href="/contact">Contactez-nous</a>.
...
}, "/Users/ano/dev/pro/restaurant/src/pages/agenda.astro", void 0);

const $$file = "/Users/ano/dev/pro/restaurant/src/pages/agenda.astro";
const $$url = "/agenda";

import { F as FlagFR, c as cn, $ as $$Layout } from '../chunks/layout_DDTLHbi7.mjs';
...
Notre restaurant
</h2> ${renderComponent($$result2, "AnimatedLink", AnimatedLink, { "client:load": true, "title": "Redirection \xE0 la page de la carte du restaurant", "href": "/en/concept", "className": "bg-primary/90", "client:component-hydration": "load", "client:component-path": "@/components/animated-link", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`
...
Réservation
</h2> ${renderComponent($$result2, "AnimatedLink", AnimatedLink, { "client:load": true, "title": "Redirection \xE0 la page de la carte du restaurant", "href": "/en/contact", "className": "bg-green-700/90", "client:component-hydration": "load", "client:component-path": "@/components/animated-link", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate`
Contactez-nous
` })} </div> <div${addAttribute(cn(
    "absolute inset-0",
    "bg-gradient-to-t from-white/10 to-transparent",
...
}, "/Users/ano/dev/pro/restaurant/src/pages/en/index.astro", void 0);

const $$file = "/Users/ano/dev/pro/restaurant/src/pages/en/index.astro";
const $$url = "/en";

...
import { manifest } from './manifest_B4dPuPId.mjs';
...
const pageMap = new Map([
    ...
    ["src/pages/api/send-email.js", _page2],
    ["src/pages/api/trigger-deploy.js", _page3],
...
const _args = {
    "middlewareSecret": "a22225f0-5638-478d-9189-854d2d7da995",
